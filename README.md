...
## Pasada de orden (20/09/2026)

Se volvió a esta versión después de probar una recomposición más fuerte que
cambiaba demasiado el carácter. Sobre ella se hizo una pasada de orden que **no
toca composición, fotografías ni fondos**:

- **Cadencia de folios.** Antes todos los folios repetían el mismo valor de aire
  y los dos que abren con foto a sangre quedaban en cero, así que los intervalos
  entre secciones se leían arbitrarios. Ahora hay tres alturas (`--folio-y-l` /
  `--folio-y` / `--folio-y-s`): la apertura respira más, los folios con foto a
  sangre siguen sin aire arriba —la imagen toca el borde— pero cierran abajo con
  el mismo aire que el resto.
- **El aire de cierre pasó al folio.** Estaba repartido en hijos sueltos
  (`.secuencia`, `.ciudad__vertical`); ahora lo pone la sección.
- **El romano salió de encima de la fotografía.** En compraventa y La Plata
  caía sobre la imagen; ahora se alinea al pie de la caja de texto.
- **Escribanas:** título y fotografía compartían la columna 6 y se tocaban.
  Título 1–5, foto 7–12.
- **Escala de espaciado** base 4 (`--e1`…`--e10`) en lugar de valores sueltos.
- **Contraste:** el número de paso usaba el latón de los ornamentos y quedaba en
  3,4:1 sobre pergamino. Se oscureció sólo ahí.
- **Blanco táctil** de 44 px en el botón de menú.
